...
function Appointment(){
    const [formData, setFormData] = useState({name: "", phone: "", specialist: "", doctor: "", time: "", email: ""});
    ...
    const validate = () => {
      ...
      if(formData.specialist == "Выберите необходимого специалиста"){
        newErrors.specialist = "Выберите необходимого специалиста"
        message += newErrors.specialist + " "
      }

      if(formData.doctor == "Выберите врача"){
                    ...
                    <form id="makeapp" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <select name="specialist" id="specialist" value={formData.specialist} onChange={handleChange}>
                                <option>Выберите необходимого специалиста</option>
